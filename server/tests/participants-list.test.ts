...
describe('GET /admin/participantes and /conteos (BR-001, BR-007)', () => {
	...
	describe('listing', () => {
		...
		it.each([
			...
			['page=1.5', 'page debe ser un número entero, escrito solo con cifras.'],
			['page=1e2', 'page debe ser un número entero, escrito solo con cifras.'],
			['pageSize=0x10', 'pageSize debe ser un número entero, escrito solo con cifras.'],
			['page=%202', 'page debe ser un número entero, escrito solo con cifras.'],
			['page=-1', 'page debe ser 1 o mayor.'],
			['page=', 'page debe ser un número.'],
